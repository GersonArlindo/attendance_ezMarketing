...
<div class="col-md-6">
    <form action="" id="user-form">
        ...
        <div class="form-group">
            <label for="old_password" class="control-label">Previous Password</label>
            <input type="password" name="old_password" id="old_password" class="form-control form-control-sm rounded-0" value="">
        </div>
        <div class="form-group">
            <small class="text-info">Leave the password field blank if you do not wish to update your password.</small>
        </div>
        <div class="form-group d-flex w-100 justify-content-end">
            <button class="btn btn-sm btn-primary rounded-2 my-1">Update</button>
        </div>
    </form>
</div>

...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" id="topNavBar" style="background-color: black;">
        <div class="container">
            ...
            <img src="../images/logoOficial.png" alt="" width="10%" height="25%">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'attendance_list')? 'active' : '' ?>" href="./?page=attendance_list"><i class="fa fa-th-list"></i> Assistance</a>
                    </li>
                    <!--New -->
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'reports')? 'active' : '' ?>" href="./?page=reports"><i class="fa-solid fa-chart-pie"></i> Reports</a>
                    </li>
                    <!--New-->
    ...
    <div class="modal fade" id="uni_modal" role='dialog' data-bs-backdrop="static" data-bs-keyboard="true">
        ...
        <div class="modal-footer py-1">
            ...
            <button type="button" class="btn btn-sm rounded-2 btn-secondary" data-bs-dismiss="modal">Cerrar</button>
        </div>
        </div>
        </div>
    </div>

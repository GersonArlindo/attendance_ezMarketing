        ...
        <div id="outprint">
            <table class="table table-hover table-striped table-bordered" id="list">
                ...
                <tbody>
                    ...
                    $log_type = array('IN' => 'Log In', 'L_OUT' => 'Luch / Break Out', 'L_IN' => 'Luch / Break In', 'OUT' => 'Log Out');
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="py-1 px-1 lh-1">
                                <small><span class="text-muted">Name:</span> <?php echo $row['name'] ?></small><br>
                            ...
                            <td class="py-1 px-1 lh-1">
                                ...
                                <small><span class="text-muted">Device:</span>
                                    ...
                                    <?php else : ?>
                                        <span><span class="fa fa-mobile-alt text-primary"></span> Phone</span>
                                    <?php endif; ?>
                                </small><br>
                            ...
                            <th class="text-center py-1 px-2 align-middle">
                                <div class="btn-group" role="group">
                                    <button id="btnGroupDrop1" type="button" class="btn btn-primary dropdown-toggle btn-sm rounded-2 py-0" data-bs-toggle="dropdown" aria-expanded="false">
                                        Actions
                                    </button>
                                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                        <li><a class="dropdown-item view_data" data-id='<?php echo $row['attendance_id'] ?>' href="javascript:void(0)">Details</a></li>
...
<script>
    ...
    $(function() {
        $('.view_data').click(function() {
            uni_modal("Registration Attendance Details", 'view_att.php?id=' + $(this).attr('data-id'), 'large')
        })
        ...
        $('#print').click(function() {
            ...
            el.append(_h)
            el.append('<h2 class="text-center fw-bold">Attendance Record List</h2>')
            el.append('<hr/>')
            el.append(_p)

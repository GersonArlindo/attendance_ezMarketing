                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="position_id" id="position_id" class="form-select form-select-sm select2 rounded-0">
                            <option <?php echo (!isset($position_id)) ? 'selected' : '' ?> disabled>Select Position</option>
                            <?php
                    ...
                    <!--SELECT PARA LAS CAMPAÑAS -->
                    <div class="form-group">
                        <label for="campaign_id" class="control-label">Campaign</label>
                        <select name="campaign_id" id="campaign_id" class="form-select form-select-sm select2 rounded-0">
                            <option <?php echo (!isset($campaign_id)) ? 'selected' : '' ?> disabled>Select Campaign</option>
                            <?php
                            $campaign = $conn->query("SELECT * FROM campaign_list where `status` = 1 " . (isset($campaign_id) ? " or campaign_id ='{$campaign_id}'" : "") . " order by `campaign_name` asc");
                            while ($row = $campaign->fetchArray()) :
                            ?>
                                <option value="<?php echo $row['campaign_id'] ?>" <?php echo (isset($campaign_id) && $campaign_id == $row['campaign_id']) ? 'selected' : '' ?>><?php echo $row['campaign_name'] ?></option>
                            <?php endwhile; ?>
                        </select>
                    </div>
                    <!--SELECT PARA LAS CAMPAÑAS -->
